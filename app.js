  ...
  for (let i = 1; i < 10; i++) {
    ...
    function entergrades(clickedid){
      ...
      if(clickedid=="inputfield1"||clickedid=="inputfield2"||clickedid=="inputfield3"||clickedid=="inputfield4"||clickedid=="inputfield5"){
        ...
        document.getElementById('finalgrade2').innerText = grades2+"%";
      }
        ...
        document.getElementById('finalgrade3').innerText = grades3+"%";
      }
        ...
        document.getElementById('finalgrade4').innerText = grades4+"%";
      }
        ...
        document.getElementById('finalgrade5').innerText = grades5+"%";
      }
        ...
        document.getElementById('finalgrade6').innerText = grades6+"%";
        ...
        document.getElementById('finalgrade7').innerText = grades7+"%";
      }
        ...
        document.getElementById('finalgrade8').innerText = grades8+"%";
      }
        ...
        document.getElementById('finalgrade9').innerText = grades9+"%";
      }
